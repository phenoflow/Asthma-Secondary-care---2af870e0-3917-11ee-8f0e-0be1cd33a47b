...
(async () => {
  ...
  await fs.writeFile("asthma-secondary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("asthma-secondary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
